        ...
        function init(wrapper) {
            if (!wrapper.hasClass('js-wc-star-rating')) {
                ...
                for (let i = 1; i <= settings.stars; i++) {
                    ...
                    let startColor = settings.starColorEmpty, starIconColor = settings.starIconEmpty  ;
                    if (settings.defaultStars > 0 && settings.defaultStars > (i -1) ) {
                        startColor = settings.starColorFull;
                        starIconColor = settings.starIconFull;
                    }
